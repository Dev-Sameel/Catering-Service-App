...
Future<void> addConfirmedWork(List<String> workIds, String uId) async {
  final DocumentReference userSkillsDoc = FirebaseFirestore.instance
    .collection('User Reg')
    .doc(uId);
  ...
  try {
    ...
    List<Map<String, dynamic>> currentWork = List<Map<String, dynamic>>.from(snapshot.get('confirmedWork'));
  ...
  return Get.defaultDialog(
    ...
    actions: [
      ...
      confirmButton('Confirm', kBlack, kWhite,() async{
        await addConfirmedWork([workId],uId);
      }),
    ],
  );
}
